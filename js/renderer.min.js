...
`;render(page(),document.body),document.title="CryptoAlgo";const lastTab=get("lastTab");switch(lastTab){case"text":textInflate(!1);break;case"file":fileInflate(!1);break;case"RSA":RSAInflate(!1);break;case"keygen":keyGenInflate(!1);break;default:keyGenInflate(!1)}