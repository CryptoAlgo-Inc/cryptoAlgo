...
`;render(page(),document.body);const lastTab=get("lastTab");switch(lastTab){case $textID:textInflate();break;case $fileID:fileInflate();break;case $RSA_ID:RSAInflate();break;case $keyGenID:keyGenInflate();break;default:keyGenInflate()}